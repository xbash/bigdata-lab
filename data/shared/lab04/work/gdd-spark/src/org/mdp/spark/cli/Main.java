	...
	public static void main(String[] args) {
		try {
			if (args.length < 1) {
				...
				sb.append("\n\t"+AverageSeriesRating.class.getSimpleName()+": Get average ratings of TV series episodes");
				sb.append("\n\t"+InfoSeriesRating.class.getSimpleName()+": Get best episode info and average ratings per TV series");
