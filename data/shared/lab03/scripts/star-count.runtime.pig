...
raw = LOAD 'hdfs://master:9000/inputs/lab03/imdb-stars-test.tsv' USING PigStorage('\t') AS (actor, title, year, type, char, gender);
...
STORE ordered_actor_count INTO 'hdfs://master:9000/outputs/lab03/star-count-20260803-232838';
